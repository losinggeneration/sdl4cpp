...
namespace SDL
{
	 ...
	 *
	 * This is all the functions in SDL that have to do directly with SDL's CD
	 * handling.
	 */
	//@}
	class CD
	{
		public:
			/*!
			 * Constructor that sets up m_CD to NULL, and Open() must be called
			 * later
			 */
			CD();
			/*!
			 * Constructor that takes a drive as its argument to open it and
			 * set up m_CD for use
			 *
			 * \param drive is the drive number to load into this class
			 *
			 * \throws SDL::RuntimeError if the cdrom is not opened
			 */
			CD(int drive);
			/*!
			 ...
			 * default CD-ROM.
			 * \note This should be called before anything else if the default
			 * constructor is used.
			 *
			 * \return True if the cd drive is opened sucessfully, False if
			 * not.
			 */
			bool Open(int drive);
			 ...
			 * current play position of the CD will be stored in m_CD.
			 *
			 * The macro CD_INDRIVE is provided for convenience, and given a
			 * status returns true if there's a disk in the drive.
			 *
			 ...
			 * CD-ROM. drive is the index of the drive. Drive indices start to
			 * 0 and end at CDNumDrives()-1.
			 *
			 * \return A strinf of a human-readable, system-dependent
			 ...
			 * \brief Play a CD
			 *
			 * Plays the cdrom defined in Open(), starting a frame start for
			 * length frames.
			 *
			 ...
			 *
			 * Plays the given CD starting at track start_track, for ntracks
			 * tracks.
			 *
			 ...
			 *
			 * CDPlayTracks() should only be called after calling Status() to
		...
		protected:
			 ...
			 *
			 * m_Drive is used to store the drive that the class is currently
			 * working with
			 */
			int m_Drive;
