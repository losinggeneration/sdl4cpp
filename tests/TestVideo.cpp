...
int main(int argv, char *args[])
{
	...
	if(Four == Two)
		...
		std::cout << "Bad: Four and Two are not equal"  << std::endl;
	...
	//  Should not be equal
	if(icon == Four)
		std::cout << "Bad: icon and Four are equal" << std::endl;
	else
	...
	if(temp == icon)
		...
		std::cout << "Bad: temp and icon aren't equal" << std::endl;
	...
	if(icon == One)
		...
		std::cout << "Bad: One and icon aren't equal" << std::endl;

	if(Two != One)
		std::cout << "Good: Two does NOT equal One." << std::endl;
	else
		std::cout << "Bad: Two DOES equal One." << std::endl;
